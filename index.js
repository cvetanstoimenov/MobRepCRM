...
function onLoad(){
	...
	$("#second").on("click", "li", function () {
	    ...
	    SetDataOnModal(currentTaskStatusOfSelectedClan, IdOfSelectedClan);
	...
	function DisplayResult(array) {
      ...
      function SetDataOnModal(currentTaskStatusOfSelectedClan, IdOfSelectedClan) {
		  $("#IdOfSelectedClan").empty();
		  $("#IdOfSelectedClan").append(IdOfSelectedClan);
